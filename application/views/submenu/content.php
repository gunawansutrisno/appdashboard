        ...
        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title" id="form-head">Tambah Data Sub Menu / Object</h3>
                </div>
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formAuthor">
                    <input type="hidden" id="id" name="id" value="" />
                   <div class="form-group">
                        <label>Nama Sub Menu / Object</label>
                        <input type="text" class="form-control" placeholder="ex: Local Export and Top Customer" name="nama" id="name" required="required">
                        <p class="help-block">Sub Menu / Object</p>
                    </div>
                    <div class="form-group">
                            <label> Kategori Menu Dashboard</label>
                             ...
                             <select id="menu_id"  name="menu_id" class="form-control">
                                                ...
                                                <?php foreach ($menu as $r) { ?>
                                                    <option value="<?= $r->id ?>" <?php $lv[$r->id] = $r->nama ? 'selected': '' ;?>>
                                                    <?=$r->nama?>
                                                        <?php $lv[$r->id] = $r->nama?>
                                                    </option>
                                                <?php } ?>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo BASE_URL('submenu');?>"><button type="button" style="display: none;"  id="batal" class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-backward"></span> Batal </button></a>
            ...
            <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">List Data Manajemen Perusahaan</h3>
                </div>
                    <div class="box-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin menghapus data Jenis Index ini ? </b></h4>
                    </div>
