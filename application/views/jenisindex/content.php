        ...
        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title" id="form-head">Tambah Data Manajemen Perusahaan</h3>
                </div>
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formAuthor">
                    <input type="hidden" id="id" name="id" value="" />
                   <div class="form-group">
                        <label>Nama Manajemen Perusahaan</label>
                        <input type="text" class="form-control" placeholder="ex: Direksi" name="name" id="name" required="required">
                        <p class="help-block">Nama Manajemen Perusahaan</p>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-save-file"></span> Simpan</button> 
                        <a href="<?php echo BASE_URL('jenisindex');?>"><button type="button" style="display: none;"  id="batal" class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-backward"></span> Batal </button></a>
