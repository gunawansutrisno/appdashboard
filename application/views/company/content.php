        ...
        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title" id="form-head">Tambah Data Perusahaan</h3>
                </div>
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formicd">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="ex: MMI" name="code" id="code">
                        <!--<p class="help-block">Code ICD</p>-->
                    </div>
                   <div class="form-group">
                        <label>Nama Perusahaan</label>
                        <textarea class="form-control" rows="3" placeholder="ex: PT. Madusari Murni Indah" name="in_bahasa" id="in_bahasa"></textarea>
                        <!--<p class="help-block">Desciption</p>-->
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat"><span class="glyphicon glyphicon-save-file"></span> Simpan</button> 
                        <a href="<?php echo BASE_URL('code');?>"><button type="button" style="display: none;"  id="batal" class="btn btn-warning btn-flat"><span class="glyphicon glyphicon-backward"></span> Batal </button></a>
